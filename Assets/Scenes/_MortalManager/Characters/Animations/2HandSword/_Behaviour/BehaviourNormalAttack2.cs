...
public class BehaviourNormalAttack2 : StateMachineBehaviour
{
    [Header("Filter")]
    [SerializeField] private string onlyStateName = "NormalAttack_2";
    ...
    public override void OnStateEnter(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.GetComponentInParent<MyCharacterCore>()?.OnNormalAttackEnter(2);
    }
    ...
    public override void OnStateUpdate(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        {
            _firedStart = true;
            core.OnSwordSlashStart(2);
        }

        if (!_firedHit && n >= hitN)
        {
            _firedHit = true;
            core.OnSwordSlashHit(2);
        }

        if (!_firedEnd && n >= slashEndN)
        {
            _firedEnd = true;
            core.OnSwordSlashEnd(2);
        }
    }
    ...
    public override void OnStateExit(Animator animator, AnimatorStateInfo stateInfo, int layerIndex)
    {
        ...
        animator.GetComponentInParent<MyCharacterCore>()?.OnNormalAttackExit(2);
    }
